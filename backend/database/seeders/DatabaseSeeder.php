...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $perfectMatchUser = User::factory()->create(['name' => 'Perfect Match']);
        ...
        $regionMatchUser = User::factory()->create(['name' => 'Region Match']);
        ...
        $perfectMatchUser2 = User::factory()->create(['name' => 'Perfect Match 2']);
        ...
        $wrongRegionUser = User::factory()->create(['name' => 'Wrong Region']);
