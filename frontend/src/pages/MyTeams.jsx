                        ...
                        {teamProfiles.map((profile) => (
                            <tr key={profile.id} className="hover:bg-[#1a1a1a] transition-colors">
                                ...
                                <td className="px-6 py-5 text-right space-x-2">
                                    <button className="text-gray-500 hover:text-white p-2 rounded-md hover:bg-gray-800 transition-colors"><Eye size={16} /></button>
                                    <button className="text-brand-red hover:text-[#FF4D4D] p-2 rounded-md hover:bg-brand-red/10 transition-colors"><Pencil size={16} /></button>
